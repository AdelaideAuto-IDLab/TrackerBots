function [ax,hlines] = plotyyy(x1,y1,x2,y2,x3,y3,ylabels,varargin)
%PLOTYYY - Extends plotyy to include a third y-axis
%
%Syntax:  [ax,hlines] = plotyyy(x1,y1,x2,y2,x3,y3,ylabels,x_label,font_size)
%
...
%        x_label is the label of x axis strings
%        font_size is size of x,y axis interger
%
...
% if nargin==6 
%    %Use empty strings for the ylabels and x_label
%    ylabels{1}=' '; ylabels{2}=' '; ylabels{3}=' '; x_label = ' '; font_size = 1;
% elseif nargin > 9
...
ax(3)=axes('Position',pos3,'box','off',...
   'Color','none','YColor','m','xlim',limx3,'yaxislocation','right');
