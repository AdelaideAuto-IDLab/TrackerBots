% dbp.m - polar gain plot in dB
% 
% Usage: h = dbp(th, g, rays, Rm, width)
%        h = dbp(th, g)                 (equivalent to rays=30, Rm=40, width=1)
%        h = dbp(th, g, rays)           (equivalent to Rm=40, width=1)
%        h = dbp(th, g, rays, Rm)       (equivalent to width=1)
%
...
%
% examples: dbp(th, g);                default (30-degree lines and 40-dB scale)
%           dbp(th, g, 45);            use 45-degree grid lines
%           dbp(th, g, 30, 60);        30-degree rays and 60-dB scale
%           dbp(th, g, 30, 60, 1.5);   use thicker line for gain
%
