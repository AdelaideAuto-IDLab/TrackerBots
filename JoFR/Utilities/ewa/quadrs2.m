% quadrs2.m - Gauss-Legendre quadrature weights and evaluation points on subintervals
%
% Usage: [w,x] = quadrs2(ab,N)
%        [w,x] = quadrs2(ab)         (equivalent to N=16)
%
...
%
%        substitute for QUADRS
%
% examples: [w,x] = quadrs2([1,2], 5);
%           [w,x] = quadrs2([1,1.5,2], 5);           
%           [w,x] = quadrs2(linspace(1,2,9), 5);
%
%           the operation: [w,x] = quadrs2([1,1.5,2], 5) is equivalent to:
%           [w1,x1] = quadr2(1,1.5,5); [w2,x2]=quadr2(1.5,2,5); w=[w1;w2]; x=[x1;x2]
%
%        see also QUADR2, QUADR, QUADRS
