% snell.m - Calculates refraction angles from Snell's law for birefringent media
%
% Usage: thb = snell(na,nb,tha,pol)
%        thb = snell(na,nb,tha)         (equivalent to pol='te')
%
...
%
% notes: solves Snell's law Na*sin(tha) = Nb*sin(thb) for thb, 
...
function thb = snell(na,nb,tha,pol)

if nargin==0, help snell; return; end
